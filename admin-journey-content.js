...
var SEED_VERSION = 26; // bump to force re-sync of banner text/audio from DEFAULT_DATA
...
// tw-guide-2 and tw-guide-3 removed: they are correctly encoded and the admin
// needs to edit them freely. Force-resetting them wiped admin changes on every resync.
var FORCE_RESET_BANNER_IDS = ['mn12-pano','jm12-pano','jm12-complete','mz-load','qb-load','bh-load','bu-load','ti-pano-2','ti-pano-3','jm11-pano','tf-pano-4'];
