...
var SEED_VERSION = 17; // bump to force re-sync of banner text/audio from DEFAULT_DATA
...
var FORCE_RESET_BANNER_IDS = ['mn12-pano','jm12-pano','jm12-complete','mz-load'];
    ...
    { key:'tawaf-ifadha', step:12, title:'Step 12 — Tawaf al-Ifadha', file:'pilgrimspath-vr/pilgrims path main/1 Tawaf/index.htm', context:'ifadha',
      ...
      banners:[
        ...
        defB({ id:'ti-pano-2', trigger:'panorama', panorama:'panorama_7F92DC96_71D8_1D5E_41BF_87B612A8A131', label:'Continuing Ifadha',
          text:{en:{title:'🤲 Al-Masjid Al-Haram — Tawaf al-Ifadha',body:'<p class="bb">Continue your second Tawaf, Tawaf al-Ifadha, with devotion and focus.</p><p class="bb">Remember that this Tawaf is an essential pillar of Hajj on the day of Eid al-Adha.</p>'}},
    ...
    { key:'tawaf-farewell', step:16, title:"Step 16 — Farewell Tawaf al-Wida'", file:'pilgrimspath-vr/pilgrims path main/1 Tawaf/index.htm', context:'farewell',
      ...
      banners:[
        ...
        defB({ id:'tf-pano-4', trigger:'panorama', panorama:'panorama_8AC63E8D_9544_C601_41E0_0A05A67E5557', label:'Farewell completion', template:'hero-large',
          text:{en:{title:'🎉 Hajj Complete — Mabrook!',body:'<p class="bb">Alhamdulillah — you have completed your Hajj. May Allah accept your pilgrimage and elevate your status.</p><p class="ba" style="direction:rtl;font-size:1.2em">تَقَبَّلَ اللَّهُ حَجَّكَ وَغَفَرَ ذَنْبَكَ وَأَخْلَفَ نَفَقَتَكَ</p><p class="ba">Taqabbalallahu hajjaka wa ghafara dhanbaka wa akhlafa nafaqatak.</p><p class="bt">"May Allah accept your Hajj, forgive your sins, and compensate your expenditure."</p><p class="bb">May you return to your family as a new person, pure and forgiven. Hajj Mabrook!</p>'}},
