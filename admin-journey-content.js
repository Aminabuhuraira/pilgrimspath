...
var SEED_VERSION = 27; // bump to force re-sync of banner text/audio from DEFAULT_DATA
...
// tw-guide-1/2 re-added: defaults are now updated to match what is shown on screen,
// so the JCM body matches the visible guide card content and is editable from admin.
var FORCE_RESET_BANNER_IDS = ['mn12-pano','jm12-pano','jm12-complete','mz-load','qb-load','bh-load','bu-load','ti-pano-2','ti-pano-3','jm11-pano','jm11-complete','tf-pano-4','tw-guide-1','tw-guide-2'];
  ...
  scenes: [
    ...
    { key:'tawaf-initial', step:1, title:'Step 1 — Tawaf (Initial Umrah)', file:'pilgrimspath-vr/pilgrims path main/1 Tawaf/index.htm', context:'initial',
      ...
      banners:[
        ...
        defB({ id:'tw-guide-1', trigger:'guide-screen-1', label:'🤲 Screen 2 of 4 — Cleansing & Garments', template:'ihram-guide',
          text:{en:{title:'Cleansing & Garments',body:'<p class="bb">Perform <strong>Ghusl</strong> (full ritual bath) or Wudu as a minimum before entering Ihram.</p><p class="bb"><strong>For men:</strong> Wear two white unstitched cloths — the <em>Izaar</em> (lower body) and the <em>Rida</em> (over the shoulder).</p><p class="bb"><strong>For women:</strong> Wear modest, loose clothing covering the body; your face and hands remain uncovered.</p><p class="bb">You may apply fragrance to your body (not the garments) before making your intention.</p>'}},
          audio:{en:'2 English Ihram part 1.mp3'} }),
        defB({ id:'tw-guide-2', trigger:'guide-screen-2', label:'📿 Screen 3 of 4 — Your Niyyah & the Talbiyah', template:'ihram-guide',
          text:{en:{title:'Your Niyyah & the Talbiyah',body:'<p class="bb">You must make your Niyyah before or at the Miqat — the sacred boundary you must already be in Ihram before crossing.</p><p class="bb">Declare your intention clearly:</p><p class="ba" style="direction:rtl;font-size:1.2em">اللَّهُمَّ إِنِّي أُرِيدُ الْعُمْرَةَ فَيَسِّرْهَا لِي وَتَقَبَّلْهَا مِنِّي</p><p class="ba">"Allahumma inni ureedal Umrata fa yassirha li wa taqabbalha minni"</p><p class="bt">"O Allah, I intend to perform Umrah, so make it easy for me and accept it from me."</p>'}},
    ...
    { key:'jamarat-10th', step:9, title:'Step 9 — Rami al-Aqabah (10th Day)', file:'pilgrimspath-vr/pilgrims path main/5 .../Jamarat rooftop/index.htm', context:'10th-day',
      panoramas:['panorama_691BD7D8_7C54_C286_41D8_87DAB3A1DC93','panorama_691B217E_7C54_3E7A_41D3_35A255D72204','panorama_6B19BBC3_7C55_C28B_41C0_A1D9ED0027F1'],
      banners:[
        defB({ id:'jm10-pano-aqabah', trigger:'panorama', panorama:'panorama_691BD7D8_7C54_C286_41D8_87DAB3A1DC93', label:'10th — Aqabah pillar',
    ...
    { key:'tawaf-ifadha', step:12, title:'Step 12 — Tawaf al-Ifadha', file:'pilgrimspath-vr/pilgrims path main/1 Tawaf/index.htm', context:'ifadha',
      ...
      banners:[
        ...
        defB({ id:'ti-pano-3', trigger:'panorama', panorama:'panorama_8AF67A73_955C_4E01_41DA_44BCCE2B395A', label:'Ifadha progress',
          text:{en:{title:'✅ Tawaf al-Ifadha Complete',body:'<p class="bb">Alhamdulillah! You have completed all 7 circuits of Tawaf al-Ifadha. You will now proceed to the 11th day Rami al-Jamarat — stoning of the three pillars.</p>'}},
          audio:{en:'25 English 10th day Dhul Hijjah 7.mp3'} }),
        defB({ id:'ti-pano-4', trigger:'panorama', panorama:'panorama_8AC63E8D_9544_C601_41E0_0A05A67E5557', label:'Completing Tawaf al-Ifadha',
          text:{en:{title:'🕌 Completing Tawaf al-Ifadha',body:'<p class="bb">You have completed your Tawaf al-Ifadha circuits. Your journey continues — proceed to the 11th day Rami al-Jamarat.</p>'}},
          audio:{en:''} }),
    ...
    { key:'jamarat-11th', step:13, title:'Step 13 — Rami All Pillars (11th Day)', file:'pilgrimspath-vr/pilgrims path main/5 .../Jamarat rooftop/index.htm', context:'11th-day',
      ...
      banners:[
        ...
        defB({ id:'jm11-complete', trigger:'completion', label:'After all 21 stones thrown', template:'sunrise-gold',
    ...
    { key:'jamarat-12th', step:15, title:'Step 15 — Rami All Pillars (12th Day)', file:'pilgrimspath-vr/pilgrims path main/jamarat base update 2/index.htm', context:'12th-day',
      ...
      banners:[
        ...
        defB({ id:'jm12-day13-option', trigger:'completion', label:'Decision: Stay (13th) or Depart Mina', template:'classic-gold',
        ...
        defB({ id:'jm12-complete', trigger:'completion', label:'After all 21 stones thrown', template:'classic-gold',
    ...
    { key:'tawaf-farewell', step:16, title:"Step 16 — Farewell Tawaf al-Wida'", file:'pilgrimspath-vr/pilgrims path main/1 Tawaf/index.htm', context:'farewell',
      panoramas:['panorama_8CE4041C_9544_BA06_41E1_5E77B48B16C5','panorama_7F92DC96_71D8_1D5E_41BF_87B612A8A131','panorama_8AF67A73_955C_4E01_41DA_44BCCE2B395A','panorama_8AC63E8D_9544_C601_41E0_0A05A67E5557'],
      banners:[
        defB({ id:'tf-pano-1', trigger:'panorama', panorama:'panorama_8CE4041C_9544_BA06_41E1_5E77B48B16C5', label:'Farewell entry', template:'classic-gold',
        ...
        defB({ id:'tf-pano-2', trigger:'panorama', panorama:'panorama_7F92DC96_71D8_1D5E_41BF_87B612A8A131', label:'Final moments', template:'classic-gold',
          ...
          audio:{en:''} }),
        defB({ id:'tf-pano-3', trigger:'panorama', panorama:'panorama_8AF67A73_955C_4E01_41DA_44BCCE2B395A', label:'Farewell progress', template:'classic-gold',
...
function bannerCard(b){
  ...
  '<div class="jc-banner" data-bid="'+esc(b.id)+'" id="jc-banner-'+esc(b.id)+'">'+
    ...
    '<div class="jc-row"><label>Audio file <small style="color:var(--gold)">['+esc(lang)+']</small></label>'+
      ...
      '</div>'+
    '</div>'+
    (/^guide-screen-/.test(b.trigger) || b.trigger==='button' || b.audioChain ?
